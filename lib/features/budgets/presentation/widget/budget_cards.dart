...
class BudgetCards extends ConsumerWidget {
  final List<BudgetWithCategoryModel> budgets;
  const BudgetCards({super.key, required this.budgets});
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final title = budget.title;
          final amount = currencyFormatter.format(budget.totalSpent);
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text('₱2,000', style: GoogleFonts.outfit()),
                    ),
